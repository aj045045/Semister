                                    ...
                                    <div class="row full_width" id="right">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 plr-5">
                                            ...
                                            <div class="feature-info-content text-white pl-sm-4 pl-0">
                                                <p>Eligibility</p>
                                                <h5 class="text-white">B.E. / B.Tech (Computer Science, Information Technology, Electronics &
                                                    Communication), M.C.A., M.Sc. (Information Technology, Computer Applications, Computer
                                                    Science)</h5>
                                            </div>
                                        </div>
                                    </div>
