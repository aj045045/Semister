...
<body style="background-color: #eee">
                                        ...
                                        <!-- <div class="d-flex flex-row align-items-center mb-2">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="email" id="form3Example3c" class="form-control"
                                                    placeholder="Mail" name="mail" required autocomplete="off"/>
                                            </div>
                                        </div> -->
                                        <div class="d-flex flex-row align-items-center mb-2">
    ...
    <div class="linkers">Don't have an account?<a class="text-primary" href="regist.php" target="_self">  Signup now</a></div>
                                    </form>
                                </div>
                            </div>
                        </div>
