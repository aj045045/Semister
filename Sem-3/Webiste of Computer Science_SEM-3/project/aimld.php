...
<!doctype html>
    ...
    <head>
        ...
        #bglogo {
            background-image: url(image/academics/course/tower.webp);
            background-repeat: round;
            display: block;
            width: 250px;
            padding-right: 10px;
            image-resolution: blure;
        }
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="feature-info feature-info-02 course-info bg-dark">
                                        <div class="row">
                                            <div id="bglogo">
                                                <!-- <h5 class="courseName_title">Doctor of Philosophy in Computer Science</h5> -->
                                            </div>
                                        </div>
                                        <div class="row full_width" id="right">
                                            <div class="col-md-4 col-sm-4 col-xs-4 plr-5">
                                                <div class="feature-info-icon mb-3 mb-sm-0 text-primary">
                                                    <i class="flaticon-job-3"></i>
                                                </div>
                                                <div class="feature-info-content text-white pl-sm-4 pl-0 mb-4">
                                                    <p>Program Code</p>
                                                    <h5 class="text-white">
                                                        MSCAIMLD
                                                    </h5>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 plr-5">
                                                ...
                                                <div class="feature-info-content text-white pl-sm-4 pl-0">
                                                    <p>Eligibility</p>
                                                    <h5 class="text-white">MCA, BE (CS/ IT), B.Tech (CS/IT), M.Tech, MSc
                                                        (Computer science / CA/IT),
                                                        BCA, BSc (Computer science/CA/IT) or equivalent. Candidate must
                                                        have obtained 55% marks
                                                        in qualifying exam ( 5% relaxation for SC/ST students in the
                                                        qualifying exam will be given)</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
