...
<body>
    ...
    <div class="container-fluid" style="padding-right:7%;padding-left:7%">
        <ul class="breadcrumb" style="padding-top:150px;">
            ...
            <li>Dr. Jigna Satani</li>
        </ul>
        <br>
        <div class="container-fluid">
            <div class="bg_img">
                <img class="center" src="image/logos/logo.webp" style="height: auto;width: 90px; padding-bottom: 60px;">
                <img class="center" src="image/faculties/jignaSatani.webp" style="border-radius:50%;">
                <h4 class="pr_center">Dr. JIGNA SATANI </h4>
            ...
            <div class="fd-center">
                ...
                <?php
include "config.php";
$sql = "SELECT count(`title`) as paper FROM `research` where `faculty_facultyid` =10";
