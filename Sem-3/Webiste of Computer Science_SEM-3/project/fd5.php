...
<body>
    ...
    <div style="padding-right:7%;padding-left:7%;">
        <ul class="breadcrumb" style="padding-top:150px;">
            ...
            <li>Mr. Jaykumar Patel</li>
        </ul>
        <div class="container-fluid">
            <div class="bg_img">
                <img class="center" src="image/logos/logo.webp" style="height: auto;width: 90px; padding-bottom: 60px;">
                <img class="center" src="image/faculties/jayPatel.webp" style="border-radius:50%;">
                <h4 class="pr_center">Mr. JAYKUMAR PATEL</h4>
                <p class="pr_center">Assistant Professor</p>
                <p class="pr_center">NET, GSLET, BCA, MCA</p>
            </div><br><br>
            <div class="fd-center">
            <!-- Experinc-->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <dd>
                            <dt>ASSISTANT PROFESSOR</dt>
                            <dl>Vidyabharti Trust College of BCA Umrakh</dl>
                            </dd>
                        </td>
                        <td></td>
                    </tr>
            ...
            <?php
include "config.php";
$sql = "SELECT count(`title`) as paper FROM `research` where `faculty_facultyid` =5";
